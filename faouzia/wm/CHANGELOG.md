...
* [window_put_in_grid now has two additional params to specify how many cells to
	occupy](https://github.com/tudurom/faouzia/issues/52). This is not
	optional. Sorry.
* Each window managed by the WM has a property named `FAOUZIA_STATUS` that
...
* Faouzia respects chwbb, again. (#51)
...
* [Added grid movement and resizing
  functions](https://github.com/tudurom/faouzia/pull/64) thanks to @vxid.
