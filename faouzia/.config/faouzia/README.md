# Faouzia tree (supercedes prior file based dsl)

This DSL version stores its group/window states using a directory tree off
/dev/shm/faouzia (versus /tmp) for maximum performance.
...
on hardware. The directory tree version of this Faouzia dsl is best served
