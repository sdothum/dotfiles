...
bundle kakoune-snippets https://github.com/occivink/kakoune-snippets.git %{
	...
	addm %{ paste S : map global edit '%'       ': snippets ' -docstring 'snippets' }
	addm %{ paste s : map global edit '<tab>'   'Z,c'         -docstring 'snippets   —— select,next placeholder' }
	addm %{ paste s : map global edit '<s-tab>' 'z)Z,c'       -docstring 'snippets   —— select,next placeholder' }
