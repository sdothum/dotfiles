...
bundle kakoune-snippets https://github.com/occivink/kakoune-snippets.git %{
	...
	addmodes %{ snippet 1 : map global edit '<tab>'   'Z,c'         -docstring 'snippets  —— select,next placeholder' }
	addmodes %{ snippet 2 : map global edit '<s-tab>' 'z)Z,c'       -docstring 'snippets  —— select,next placeholder' }
