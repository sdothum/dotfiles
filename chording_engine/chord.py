...
def expand_keycode_fnc(DEFINITION):
	...
	if DEFINITION in [
		...
		"F23", "F24", "F3", "F4", "F5",
		"F6", "F7", "F8", "F9",
		"AGAIN", "AGIN", "ALT_ERASE", "AMPERSAND", "AMPR",
		"APP", "APPLICATION", "ASTERISK", "ASTR", "AT",
		"AUDIO_MUTE", "AUDIO_VOL_DOWN", "AUDIO_VOL_UP",
		"BRID", "BRIGHTNESS_DOWN", "BRIGHTNESS_UP", "BRIU", "BRK",
		"BRMD", "BRMU", "BSLASH", "BSLS", "BSPACE",
		"BSPC",
		"CALC", "CALCULATOR", "CANCEL", "CAPS", "CAPSLOCK",
		"CIRC", "CIRCUMFLEX", "CLCK", "CLEAR", "CLEAR_AGAIN",
		"CLR", "COLN", "COLON", "COMM", "COMMA",
		"COPY", "CPRV", "CRSEL", "CUT",
		"DEL", "DELETE", "DLR", "DOLLAR", "DOT",
		"DOUBLE_QUOTE", "DOWN", "DQT", "DQUO",
		"EJCT", "END", "ENT", "ENTER", "EQL",
		"EQUAL", "ERAS", "ESC", "ESCAPE", "EXCLAIM",
		"EXEC", "EXECUTE", "EXLM", "EXSEL",
		"FIND",
		"GRAVE", "GRV", "GT",
		"HAEN", "HANJ", "HASH", "HELP", "HENK",
		"HOME",
		"INS", "INSERT", "INT1", "INT2", "INT3",
		"INT4", "INT5", "INT6", "INT7", "INT8",
		"INT9",
		"JYEN",
		"KANA", "KP_0", "KP_1", "KP_2", "KP_3",
		"KP_4", "KP_5", "KP_6", "KP_7", "KP_8",
		"KP_9", "KP_ASTERISK", "KP_COMMA", "KP_DOT", "KP_ENTER",
		"KP_EQUAL", "KP_MINUS", "KP_PLUS", "KP_SLASH",
		"LABK", "LALT", "LANG1", "LANG2", "LANG3",
		"LANG4", "LANG5", "LANG6", "LANG7", "LANG8",
		"LANG9", "LBRACKET", "LBRC", "LCAP", "LCBR",
		"LCMD", "LCTL", "LCTRL", "LEFT", "LEFT_ANGLE_BRACKET",
		"LEFT_CURLY_BRACE", "LEFT_PAREN", "LGUI", "LNUM", "LOCKING_CAPS",
		"LOCKING_NUM", "LOCKING_SCROLL", "LPRN", "LSCR", "LSFT",
		"LSHIFT", "LT", "LWIN",
		"MAIL", "MEDIA_EJECT", "MEDIA_FAST_FORWARD", "MEDIA_NEXT_TRACK", "MEDIA_PLAY_PAUSE",
		"MEDIA_PREV_TRACK", "MEDIA_REWIND", "MEDIA_SELECT", "MEDIA_STOP", "MENU",
		"MFFD", "MHEN", "MINS", "MINUS", "MNXT",
		"MPLY", "MPRV", "MRWD", "MSEL", "MSTP",
		"MUTE", "MUTE", "MYCM", "MY_COMPUTER",
		"NLCK", "NO", "NONUS_BSLASH", "NONUS_HASH", "NUBS",
		"NUHS", "NUMLOCK",
		"OPER", "OUT",
		"P0", "P1", "P2", "P3", "P4",
		"P5", "P6", "P7", "P8", "P9",
		"PAST", "PASTE", "PAUS", "PAUSE", "PCMM",
		"PDOT", "PENT", "PEQL", "PERC", "PERCENT",
		"PGDN", "PGDOWN", "PGUP", "PIPE", "PLUS",
		"PMNS", "POWER", "PPLS", "PRIOR", "PSCR",
		"PSCREEN", "PSLS", "PSTE", "PWR",
		"QUES", "QUESTION", "QUOT", "QUOTE",
		"RABK", "RALT", "RBRACKET", "RBRC", "RCBR",
		"RCMD", "RCTL", "RCTRL", "RETURN", "RGHT",
		"RGUI", "RIGHT", "RIGHT_ANGLE_BRACKET", "RIGHT_CURLY_BRACE", "RIGHT_PAREN",
		"RO", "RPRN", "RSFT", "RSHIFT", "RWIN",
		"SCLN", "SCOLON", "SCROLLOCK", "SELECT", "SEPARATOR",
		"SLASH", "SLCK", "SLCT", "SLEP", "SLSH",
		"SPACE", "SPC", "STOP", "SYSREQ", "SYSTEM_POWER",
		"SYSTEM_SLEEP", "SYSTEM_WAKE",
		"TAB", "TILD", "TILDE",
		"UNDERSCORE", "UNDO", "UNDS", "UP",
		"VOLD", "VOLDOWN", "VOLU", "VOLUP",
		"WAKE", "WBAK", "WFAV", "WFWD", "WHOM",
		"WREF", "WSCH", "WSTP", "WWW_BACK", "WWW_FAVORITES",
		"WWW_FORWARD", "WWW_HOME", "WWW_REFRESH", "WWW_SEARCH", "WWW_STOP",
		"ZKHK",
		]:
