...
static const uint8_t offsets[] = {20,20,40,50};
///---Colors---///
...
static const char *colors[] = {"#ff0000","#888888","#118800","#ff8800","#ffff00","#0d131a","#000000"};
...
static key keys[] = {
	...
	{  MOD ,                  XK_d,          start,               {.com = wallpaper}},
	{  MOD |SHIFT,            XK_d,          start,               {.com = background}},
	{  MOD |SHIFT|CONTROL,    XK_d,          start,               {.com = invert}},
	...
	{  MOD |SHIFT,            XK_p,          start,               {.com = passwords}},
