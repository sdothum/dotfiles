...
static const char *stretchleft[]   = {"window", "stretch", "fullleft"  , NULL};
static const char *stretchright[]  = {"window", "stretch", "fullright" , NULL};
...
static key keys[] = {
	...
	{  MOD ,                  XK_7,          start,               {.com = stretchright}},
	{  MOD ,                  XK_8,          start,               {.com = stretchleft}},
