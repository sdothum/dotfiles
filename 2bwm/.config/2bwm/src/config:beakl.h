...
static const char *restart2bwm[]      = {"2restart"                           , NULL};
// desktop control
...
static const char *tile4left[]        = {"window", "tile", "4", "left"        , NULL};
...
static const char *revert[]           = {"window", "revert"                   , NULL};
static const char *rotate[]           = {"window", "rotate"                   , NULL};
static const char *monocle[]          = {"window", "size", "monocle"          , NULL};
// terminals
...
static key keys[] = {
	...
	{  MOD |CONTROL,          XK_r,          start,               {.com = restart2bwm}},
	...
	{  MOD ,                  XK_0,          start,               {.com = revert}},
	{  MOD |SHIFT,            XK_0,          start,               {.com = layoutrevert}},
	{  MOD |CONTROL,          XK_0,          start,               {.com = layout}},
	{  MOD ,                  XK_1,          start,               {.com = rotate}},
	{  MOD ,                  XK_2,          start,               {.com = monocle}},
