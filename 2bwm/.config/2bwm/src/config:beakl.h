...
static const char *quarterleft[]   = {"window", "stretch", "quarterleft"  , NULL};
static const char *quarterright[]  = {"window", "stretch", "quarterright" , NULL};
...
static key keys[] = {
	...
	{  MOD ,                  XK_7,          start,               {.com = quarterright}},
	{  MOD ,                  XK_8,          start,               {.com = quarterleft}},
