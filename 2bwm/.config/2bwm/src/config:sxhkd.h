...
static key keys[] = {
	...
	// vertically right
	// {  MOD |SHIFT,         XK_u,          maxhalf,             {.i=TWOBWM_MAXHALF_VERTICAL_RIGHT}},     // 4K screens are too wide
	// horizontally left
	// {  MOD |SHIFT,         XK_b,          maxhalf,             {.i=TWOBWM_MAXHALF_HORIZONTAL_BOTTOM}},  // 4K screens are too wide
	// horizontally right
	// {  MOD |SHIFT,         XK_u,          maxhalf,             {.i=TWOBWM_MAXHALF_HORIZONTAL_TOP}},     // 4K screens are too wide
	//fold half vertically
	// {  MOD |SHIFT|CONTROL, XK_y,          maxhalf,             {.i=TWOBWM_MAXHALF_FOLD_VERTICAL}},
	{  MOD |SHIFT,            XK_n,          maxhalf,             {.i=TWOBWM_MAXHALF_FOLD_VERTICAL}},
	//fold half horizoutally
	// {  MOD |SHIFT|CONTROL, XK_b,          maxhalf,             {.i=TWOBWM_MAXHALF_FOLD_HORIZONTAL}},
	{  MOD |SHIFT,            XK_p,          maxhalf,             {.i=TWOBWM_MAXHALF_FOLD_HORIZONTAL}},
	//unfold vertically
	// {  MOD |SHIFT|CONTROL, XK_u,          maxhalf,             {.i=TWOBWM_MAXHALF_UNFOLD_VERTICAL}},
	{  MOD |SHIFT,            XK_l,          maxhalf,             {.i=TWOBWM_MAXHALF_UNFOLD_VERTICAL}},
	//unfold horizontally
	// {  MOD |SHIFT|CONTROL, XK_n,          maxhalf,             {.i=TWOBWM_MAXHALF_UNFOLD_HORIZONTAL}},
	{  MOD |SHIFT,            XK_f,          maxhalf,             {.i=TWOBWM_MAXHALF_UNFOLD_HORIZONTAL}},
	...
	// Iconify the window
	// {  MOD ,               XK_i,          hide,                {}},  // BUG: "hidden" is window name sensitive
	...
	// Change current workspace
		// DESKTOPCHANGE(      XK_1,                               0)        // see sxhkdrc
