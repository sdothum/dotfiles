...
if alpine
	...
	abbr usvt 'sv -u stop'
	abbr usvr 'sv -u restart'
	abbr usvi 'sv -u status'
	abbr usvl 'sv -u log'
	abbr usvw 'sv -u watch'
else if void           # runit
	abbr svd 'sv disable'
	abbr svt 'sv down'
	abbr sve 'sv enable'
...
abbr r4 'ifno "backup home,library,music,photos" || begin rsync home; rsync library; rsync music; rsync photos ;end'
abbr rm 'rm -i'
abbr rmf 'rm -f'
abbr rmr 'rm -rf'
abbr rmv 'rm -iv'
