...
require("bunny"):setup({
	hops = {
		...
		{ key = { "d", "n" }, path = "/net/downloads/nicotine",                           },
		{ key = { "d", "s" }, path = "/net/downloads/slskd",                              },
		{ key = { "d", "u" }, path = "/net/downloads/nzbs/completed",                     },
		{ key = "E",          path = "/etc",                                              },
		...
		{ key = { "q", "c" }, path = "~/qmk_firmware/keyboards/crkbd/keymaps/",           },
		{ key = { "q", "g" }, path = "~/qmk_firmware/keyboards/gboards/georgi/keymaps/",  },
		{ key = { "q", "s" }, path = "~/qmk_firmware/keyboards/splitography/keymaps/",    },
