# Cirrus tree (supercedes prior file based dsl)

This DSL version stores its group/window states using a directory tree off
/dev/shm/cirrus (versus /tmp) for maximum performance.
...
on hardware. The directory tree version of this Cirrus dsl is best served
